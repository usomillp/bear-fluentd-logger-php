 ...
 */
class App_Logger_FluentLogger extends App_Logger_BaseLogger
{
                                ...
                                $packer = null)
    {
        ...
        if (is_null($packer)) {
            ...
            $packer = new App_Logger_JsonPacker();
        }
     ...
     * get current packer
     *
     * @return Fluent_Logger_JsonPacker|PackerInterface
     */
     ...
     * @param int    $port
     * @param array  $options
     * @return self created logger object.
     */
    public static function open($host = self::DEFAULT_ADDRESS, $port = self::DEFAULT_LISTEN_PORT, array $options = array())
    {
    ...
    {
        $entity = new App_Logger_Entity($tag, $data);
